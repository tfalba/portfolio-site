...
export const ProjectSection: React.FC<ProjectSectionProps> = ({ project }) => {
  ...
  return (
    <section
      id={project.id}
      className="rounded-2xl border border-brand-light/10 bg-brand-charcoal/80 p-5 shadow-[0_10px_30px_rgba(0,0,0,0.45)] transition hover:border-brand-coral/60 hover:shadow-[0_15px_40px_rgba(0,0,0,0.55)]"
    >
      {/* Header row */}
      <button
        type="button"
