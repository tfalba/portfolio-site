...
export const ImageCarousel: React.FC<ImageCarouselProps> = ({
  ...
  return (
    <div className="flex h-full flex-col gap-4">
      <div className="relative overflow-hidden rounded-xl border border-border bg-surface-elevated/60 shadow-lg">
        <button
          type="button"
        ...
        {currentPhone?.src && (
          ...
          >
            <div className="relative rounded-[1.25rem] border border-border bg-surface-card/90 p-1 shadow-[0_15px_35px_rgba(0,0,0,0.35)] ring-1 ring-border/70">
              <div className="aspect-[9/19] w-full overflow-hidden rounded-[1.25rem] bg-surface-muted">
                <img
